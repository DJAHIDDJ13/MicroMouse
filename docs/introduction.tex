...
nos micromouses comprenant les algorithmes de mappage et de plus court chemin (\ref{sec:analyse1}) ainsi 
que les algorithmes de contrôle (\ref{sec:analyse2}) mettant en oeuvres les capteurs du véhicule ; les protocoles 
