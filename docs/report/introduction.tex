...
que les algorithmes de contrôle (\ref{sec:ProblematiqueControleDuvehicule}) mettant en oeuvres les capteurs du véhicule ; les protocoles 
réseaux de communication entre les différentes briques du projets (\ref{sec:analyse2}). \\
