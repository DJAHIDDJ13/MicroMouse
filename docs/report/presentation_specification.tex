...
\fig{pics/stm32.png}{16cm}{8cm}{Microcontrôleur, 32bit, STM32}{stm32}
...
\fig{pics/composantElectronique.png}{16cm}{8cm}{Ensemble des composantes électroniques}{compo}
...
\subsection{Génération du labyrinthe} \label{sec:gener}
Le labyrinthe constitue un élément import du projet, ce dernier représente l’environnement externe dans lequelle va se mouvoir notre Micromouse. \\


Il existe un certain nombre de problématiques liées à la construction de notre labyrinthe. Des problématiques logiques : 
\begin{itemize}
   \item Quel algorithme utiliser afin de générer notre labyrinthe ?.
   \item Quelle sont les spécificités architecturales que notre labyrinthe devra respectre ?.
   \item Ainsi que des problématique liées au monde physique : Quel matériaux utiliser pour la construction de notre labyrinthe ? (prendre en compte l’adhérence avec les roues de la Micromouse).
\end{itemize}
